...
var strat = {
   ...
   init: function()
   {
       ...
       this.addIndicator('IDLE_RSI', 'RSI', {interval: this.settings.IDLE_RSI} );
       this.addIndicator('BEAR_RSI', 'RSI', {interval: this.settings.BEAR_RSI} );
       this.addIndicator('ROC_val', 'ROC',  this.settings.ROC );
